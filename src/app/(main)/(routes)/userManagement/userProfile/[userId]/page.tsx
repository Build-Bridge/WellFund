...
const UserProfile: React.FC<PageProps> = ({ params }) => {
  return (
    <section className="p-5 bg-[#0E0F1D] h-full">
      <div className="flex items-center gap-3">
        <img src={"/avatar.svg"} alt="" />
        <div className="space-y-2">
          <h1 className="leading-[20px] text-[14px] text-white">
            Username: <span className="font-bold">USR10101</span>
          </h1>
          <p className="leading-[20px] text-[14px] text-white">
            User ID: <span className="font-bold">{params.userId}</span>
          </p>
